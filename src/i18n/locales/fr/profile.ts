...
export const profile: tLocale['profile'] = {
  ...
  reimportTitle: 'Ajouter un CV plus récent',
  ...
  reimportBody: 'Envoyez un PDF ou collez le texte et j’ajoute à votre profil tout ce qui est nouveau. Rien de ce qui existe déjà n’est écrasé.',
