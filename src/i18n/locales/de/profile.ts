...
export const profile: tLocale['profile'] = {
  ...
  tellMeTitle: 'Profil aktualisieren',
  ...
  reimportChooseBody: 'Wie sollen wir diesen Lebenslauf nutzen?',
  reimportMergeTitle: 'Mehr über mich erfahren',
  reimportMergeSub: 'Fügt Neues aus diesem Lebenslauf hinzu — behält alles, was du schon hast.',
  reimportReplaceTitle: 'Mein Profil ersetzen',
  reimportReplaceSub: 'Diesen Lebenslauf als Profil verwenden — ersetzt das Aktuelle.',
  reimportReviewTitle: 'Sieht das richtig aus?',
  ...
  dsInfoProcessing: 'Informationsverarbeitung',
  dsCommunication: 'Kommunikation',
  dsContentCreation: 'Erstellung von Inhalten',
  dsSafety: 'Sicherheit',
  dsProblemSolving: 'Problemlösung',
  ...
  photoHint: "Für Europass- und kontinentale Lebensläufe.",
}
