...
export const resumes: tLocale['resumes'] = {
  ...
  intakeLearning: 'Wird ausgewertet…',
  intakeFailed: 'Konnte das nicht lesen.',
  intakeRetry: 'Erneut versuchen',
  editTags: 'Tags',
  editTagsHint: 'Für welche Jobs ist dieser Lebenslauf? Tags helfen dir, schnell den richtigen zu finden.',
  addTagPlaceholder: 'Tag eingeben, Enter drücken',
  ...
  removeCvWarning: 'Einen zugeschnittenen Lebenslauf erneut zu erstellen kostet einen weiteren KI-Aufruf. Bereits verschickte Bewerbungen behalten ihre Fassung.',
  formatAts: "Standard",
