...
export const profile: tLocale['profile'] = {
  ...
  reimportTitle: 'Añadir un CV más reciente',
  uploadPdf: 'Subir PDF',
  ...
  reimportBody: 'Sube un PDF o pega el texto y añado a tu perfil todo lo nuevo. No se sobrescribe nada de lo que ya está.',
