...
export const settings: tLocale['settings'] = {
  ...
  creditsOf: 'de',
  proTagline: 'Todo lo de Free, más tu gemelo de IA, sin marca de agua y captación de leads.',
  planCompare: 'Qué incluye',
  featCredits: 'Créditos de IA al mes',
  featProfile: 'Página de perfil pública',
  featNoWatermark: 'Sin marca de agua',
  featAiTwin: 'Tu gemelo de IA responde a las visitas',
  featLeads: 'Captar leads',
  planMonthlyName: 'Mensual',
  planAnnualName: 'Anual',
  proPerMo: '/mes',
  proMonthlyBilled: 'facturado al mes',
  proAnnualBilled: (price: string) => `${price} facturado al año`,
  proSave: (pct: number) => `Ahorra ${pct} %`,
  upgradeCta: 'Pasar a Pro',
  proFoot: 'Cancela cuando quieras. Rellenar formularios siempre es gratis.',
