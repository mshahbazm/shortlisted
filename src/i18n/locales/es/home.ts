...
export const home: tLocale['home'] = {
  buildProfileTitle: 'Crea tu perfil',
  buildProfileSub: 'Añade tu experiencia para que Shortlisted rellene solicitudes y adapte tu CV.',
  buildProfileCta: 'Crear mi perfil',
