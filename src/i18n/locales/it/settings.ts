...
export const settings: tLocale['settings'] = {
  ...
  creditsOf: 'di',
  proTagline: 'Tutto di Free, più il tuo gemello IA, senza filigrana e la raccolta di lead.',
  planCompare: 'Cosa ottieni',
  featCredits: 'Crediti IA al mese',
  featProfile: 'Pagina profilo pubblica',
  featNoWatermark: 'Senza filigrana',
  featAiTwin: 'Il gemello IA risponde ai visitatori',
  featLeads: 'Raccogli lead',
  planMonthlyName: 'Mensile',
  planAnnualName: 'Annuale',
  proPerMo: '/mese',
  proMonthlyBilled: 'addebito mensile',
  proAnnualBilled: (price: string) => `${price} con addebito annuale`,
  proSave: (pct: number) => `Risparmia ${pct}%`,
  upgradeCta: 'Passa a Pro',
  proFoot: 'Disdici quando vuoi. Compilare i moduli è sempre gratis.',
