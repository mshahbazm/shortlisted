...
export const resumes = {
  ...
  uploading: 'Uploading…',
  intakeLearning: 'Learning from this…',
  intakeFailed: 'Couldn’t read this one.',
  intakeRetry: 'Retry',
  editTags: 'Tags',
  editTagsHint: 'What jobs is this CV for? Tags help you grab the right one fast.',
  addTagPlaceholder: 'Type a tag, press Enter',
  ...
  removeCvWarning: 'Making a tailored CV again is another AI call. Applications you already sent keep the copy that went with them.',
  formatAts: "Standard",
