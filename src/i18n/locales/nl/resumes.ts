...
export const resumes: tLocale['resumes'] = {
  ...
  uploading: 'Uploaden…',
  intakeLearning: 'Hiervan aan het leren…',
  intakeFailed: 'Kon dit cv niet lezen.',
  intakeRetry: 'Opnieuw',
  editTags: 'Tags',
  editTagsHint: 'Voor welke banen is dit cv? Tags helpen je snel de juiste te pakken.',
  addTagPlaceholder: 'Typ een tag, druk op Enter',
  ...
  removeCvWarning: 'Opnieuw een cv op maat maken kost weer een AI-aanroep. Al verstuurde sollicitaties houden het exemplaar dat meeging.',
  formatAts: "Standard",
