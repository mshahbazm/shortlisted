...
export const profile: tLocale['profile'] = {
  ...
  reimportTitle: 'Een nieuwer cv toevoegen',
  ...
  reimportBody: 'Upload een pdf of plak de tekst; ik voeg alles wat nieuw is toe aan je profiel. Wat er al staat, wordt niet overschreven.',
