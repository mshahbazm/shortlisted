...
export const profile: tLocale['profile'] = {
  ...
  reimportBody: 'Wgraj PDF albo wklej tekst, a dodam do profilu wszystko, co nowe. Nic z tego, co już masz, nie zostanie nadpisane.',
